package com.realpower.petition.util.record;
...
import com.realpower.petition.util.CommenUtil;
    ...
    public String startRecording(Context appContext) {
        ...
        try {
          ...
          /*  recorder.setOutputFormat(MediaRecorder.OutputFormat.AMR_NB);
            ...
            // User.getVoicePath());
            voiceFileName = getVoiceFileName("realpower");
            voiceFilePath = CommenUtil.getCacheDirectory(appContext, "") + "/" + voiceFileName;
            ...
            Log.e("voice", "prepare() failed    " + e.getMessage());
        }
        ...
        Log.e("aaa", "start voice recording to file:" + file.getAbsolutePath());
