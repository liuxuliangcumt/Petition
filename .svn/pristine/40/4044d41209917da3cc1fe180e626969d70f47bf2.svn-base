...
import com.realpower.petition.keepalive.DaemonEnv;
import com.realpower.petition.server.LocationServer;
import com.realpower.petition.server.LocationServerLive;
...
public class MyApplication extends Application {
    ...
    public void onCreate() {
      ...
      /*  CrashHandler crashHandler = CrashHandler.getInstance();
        ...
        DaemonEnv.initialize(this, LocationServerLive.class, DaemonEnv.DEFAULT_WAKE_UP_INTERVAL);
        LocationServerLive.sShouldStopService = false;
        DaemonEnv.startServiceMayBind(LocationServerLive.class);
        setTengXun();
        ...
        if (MsfSdkUtils.isMainProcess(this)) {
            ...
            TIMManager.getInstance().setOfflinePushListener(new TIMOfflinePushListener() {
                ...
                public void handleNotification(TIMOfflinePushNotification notification) {
                    Log.e("MyApplication", "recv offline push离线推送");
...
//将用户配置与通讯管理器进行绑定
        ...
        TIMManager.getInstance().addMessageListener(new TIMMessageListener() {
            ...
            public boolean onNewMessages(List<TIMMessage> list) {
                Log.e("aaa", "新消息  " + list.get(0).getMsg().toString());
