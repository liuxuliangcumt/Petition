package com.realpower.petition.keepalive;
...
public abstract class AbsWorkService extends Service {
    ...
    protected int onStart(Intent intent, int flags, int startId) {
        ...
        if (mFirstStarted) {
           ...
           /* getPackageManager().setComponentEnabledSetting(new ComponentName(getPackageName()+".keepalive", WatchDogService.class.getName()),
