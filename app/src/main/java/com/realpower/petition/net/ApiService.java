...
public interface ApiService {
    ...
    Call<StringResult> updateBaseInfo(@Body BaseInfoBean bean);
    ...
    @POST("monitoredapp/suggestion/upload")
    Call<UrlResult> upload(@Body MultipartBody multipartBody);
}
