...
import com.realpower.petition.fragment.PetitionGroupFragment;
import com.realpower.petition.fragment.PetitionGroupFragment_;
import com.realpower.petition.fragment.PetitionSFragment;
import com.realpower.petition.fragment.PetitionSFragment_;
import com.realpower.petition.fragment.SuggestGroupFragment;
import com.realpower.petition.fragment.SuggestGroupFragment_;
...
public class MainActivity extends BaseActivity {
    ...
    TabLayout tablayout;
    PetitionGroupFragment petitionGroupFragment;
    SuggestGroupFragment suggestGroupFragment;
    MeFragment meFragment;
    HomeFragment homeFragment;
    PetitionSFragment petitionSFragment;
    ...
    void onInitViews() {
        ...
        petitionSFragment = PetitionSFragment_.builder().build();
        petitionGroupFragment = PetitionGroupFragment_.builder().build();
        meFragment = MeFragment_.builder().build();
        suggestGroupFragment = SuggestGroupFragment_.builder().build();
    ...
    private void onTabItemSelected(int position) {
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                fragment = petitionGroupFragment;
                break;
            case 2:
                fragment = suggestGroupFragment;
                break;
